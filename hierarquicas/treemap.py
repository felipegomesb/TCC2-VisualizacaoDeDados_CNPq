...
fig = px.treemap(df, path=[px.Constant("Areas do conhecimento"), 'grande_area', 'area', 'subarea'], values='total', color='grande_area')
...
#fig.write_html("resultados/treemap/treemap_areasDoConhecimento.html")
fig.show()